...
#The goal of the assignment is to explore the NOAA Storm Database and explore the 
#effects of severe weather events on both population and economy.The database 
#covers the time period between 1950 and November 2011.

#The following analysis investigates which types of severe weather events are 
#most harmful on:
        
#1.  Health (injuries and fatalities)
#2.  Property and crops (economic consequences)

#Information on the Data: (https://d396qusza40orc.cloudfront.net/repdata%2Fpeer2_doc%2Fpd01016005curr.pdf)
--------------------
-2: Data Processing
--------------------
...
#Download the raw data file and extract the data into a dataframe.Then convert 
#to a data.table
...
download.file(fileUrl, destfile = paste0(getwd(), 
        '/repdata%2Fdata%2FStormData.csv.bz2'),method = "curl")
...
### 2.3: Data Subsetting
------------------------
#Subset the dataset on the parameters of interest. Basically, we remove the 
#columns we don't need for clarity.
...
stormDT <- stormDT[(EVTYPE != "?" & 
             ...
             c("EVTYPE", "FATALITIES", "INJURIES", "PROPDMG", "PROPDMGEXP",
               "CROPDMG", "CROPDMGEXP")]
                                                                            
                                                                            
----------------------------------------------------------------------
### 2.4: Converting Exponent Columns into Actual Exponents instead of 
###     (-,+, H, K, etc)
----------------------------------------------------------------------

#Making the PROPDMGEXP and CROPDMGEXP columns cleaner so they can be used to 
#calculate property and crop cost.
